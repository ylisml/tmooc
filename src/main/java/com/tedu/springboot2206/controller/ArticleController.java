...
public class ArticleController {
    ...
    public void writeArticle(HttpServletRequest request, HttpServletResponse response){
        ...
        if (    title.trim()==null||title.trim().isEmpty()||
                author.trim() == null||author.trim().isEmpty()||
                content.trim() == null||content.trim().isEmpty()
        ){
            try {
    ...
    public void artcileList(HttpServletRequest request,HttpServletResponse response){
